...
// State of a service, it is internal to tac, when it is 'wait', the cookie modal is prompted
export const WAIT_STATE = 'wait';

export const PASS_SPORT_URI = 'https://www.pass.sports.gouv.fr/';
