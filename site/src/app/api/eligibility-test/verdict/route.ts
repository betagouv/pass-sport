...
const schema = z.object({
  ...
  beneficiaryLastname: z.string().min(1).max(100),
  beneficiaryFirstname: z.string().min(1).max(100),
  beneficiaryBirthDate: z.string().min(1).max(10),
  recipientResidencePlace: z.string().min(1).max(10),
  recipientEmail: z.email().max(254),
  recipientLastname: z.string().max(100).optional(),
  recipientFirstname: z.string().max(100).optional(),
  recipientCafNumber: z.string().max(20).optional(),
  recipientIneNumber: z.string().max(20).optional(),
  recipientBirthDate: z.string().max(10).optional(),
  recipientBirthCountry: z.string().max(5).optional(),
  recipientBirthPlace: z.string().max(10).optional(),
});
