...
export function AccordionsFaq() {
  return (
    <>
      ...
      <Accordion label="Vous êtes une structure affiliée à l’une des 120 fédérations sportives et 22 groupements nationaux agréés par le ministère des Sports, de la Jeunesse et de la Vie associative">
        <p>test</p>
      </Accordion>
