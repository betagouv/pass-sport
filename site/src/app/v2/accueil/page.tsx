    ...
    <>
      <main className={styles.main} tabIndex={-1} id={SKIP_LINKS_ID.mainContent} role="main">
        ...
        <section className={cn('fr-container', styles['first-middle-section'])}>
          ...
          <div>
            <Image src={runningTracks} alt=""></Image>
          </div>
        </section>
        ...
        <section className={cn('fr-container', styles['second-middle-section'])}>
          <div>
            ...
            <Link
              ...
              target="_blank"
              className="fr-link align-self--baseline"
            >
          ...
          <div>
            <Image src={wheelchairBasketball} alt=""></Image>
          </div>
        </section>
        ...
        {/*<section className={cn('fr-mx-npm auto', 'fr-pt-6w', styles['video-section'])}>*/}
